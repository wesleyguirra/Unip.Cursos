...
exports.__esModule = true;
var ease = __webpack_require__(4);
var Segment = __webpack_require__(15);
var $ = __webpack_require__(1);
var pathA = $("#pathA").get(0), pathB = $("#pathB").get(0), pathC = $("#pathC").get(0), primeirosegmento = new Segment(pathA, 8, 32), segundosegmento = new Segment(pathB, 8, 32), terceirosegmento = new Segment(pathC, 8, 32);
function inAC(segment) {
    segment.draw('80% - 24', '80%', 0.3, { delay: 0.1, callback: function () { inAC2(segment); } });
}
function inAC2(segment) {
    segment.draw('100% - 54.5', '100% - 30.05', 0.1, { easing: ease.easeElasticOut(1, 0.3) });
}
function inB(segment) {
    segment.draw(2, 26, 0.1, { callback: function () { inB2(segment); } });
}
function inB2(segment) {
    segment.draw(20, 20, 0.3, { easing: ease.easeBounceOut(1, 0.3) });
}
function outAC(segment) {
    segment.draw('90% - 24', '90%', 0.1, { easing: ease.easeElasticIn(1, 0.3), callback: function () { outAC2(segment); } });
}
function outAC2(segment) {
    segment.draw('20% - 24', '20%', 0.1, { callback: function () { outAC3(segment); } });
}
...
function animateMenu(trigger, closeIcon) {
    if (closeIcon === void 0) { closeIcon = true; }
    return trigger.on('click touchStart', function () {
        if (closeIcon) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_linear__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_quad__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_cubic__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_poly__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_sin__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_exp__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_circle__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_bounce__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_back__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_elastic__ = __webpack_require__(14);
...
function outAC2(segment) {
    segment.draw('20% - 24', '20%', 0.3, { callback: function () { outAC3(segment); } });
}
function outAC3(segment) {
    segment.draw(8, 32, 0.1, { easing: ease.easeElasticOut(1, 0.3) });
}
...
function inAC2(segment) {
    segment.draw('100% - 54.5', '100% - 30.05', 0.3, { easing: ease.easeElasticOut(1, 0.3) });
}
function inB(segment) {
    segment.draw(2, 26, 0.1, { callback: function () { inB2(segment); } });
}
